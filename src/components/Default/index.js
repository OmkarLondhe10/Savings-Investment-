...
const Default = () => {
  ...
  const [sipData] = useState([
    ...
    { id: 1,name: 'SBI Bluechip Fund', category: 'Large Cap', returns: '17' },
    { id: 2,name: 'Axis Bluechip Fund', category: 'Large Cap', returns: '16' },
    { id: 3,name: 'Mirae Asset Large Cap Fund', category: 'Large Cap', returns: '16' },
    { id: 4,name: 'ICICI Pru Bluechip Fund', category: 'Large Cap', returns: '18' },
    { id: 5,name: 'HDFC Top 100 Fund', category: 'Large Cap', returns: '19' },
    { id: 6,name: 'Quant Large Cap Fund', category: 'Large Cap', returns: '25' },
    
    // Mid Cap Funds
    { id: 7,name: 'Quant Mid Cap Fund', category: 'Mid Cap', returns: '35' },
    { id: 8,name: 'Motilal Oswal Midcap Fund', category: 'Mid Cap', returns: '28' },
    { id: 9,name: 'Kotak Emerging Equity Fund', category: 'Mid Cap', returns: '22' },
    { id: 10,name: 'Nippon India Growth Fund', category: 'Mid Cap', returns: '27' },
    { id: 11,name: 'HDFC Mid-Cap Opportunities Fund', category: 'Mid Cap', returns: '25' },
    { id: 12,name: 'SBI Magnum Midcap Fund', category: 'Mid Cap', returns: '24' },
    

    // Small Cap Funds
    { id: 13,name: 'Quant Small Cap Fund', category: 'Small Cap', returns: '40' },
    { id: 14,name: 'Nippon India Small Cap Fund', category: 'Small Cap', returns: '32' },
    { id: 15, name: 'HDFC Small Cap Fund', category: 'Small Cap', returns: '28' },
     { id: 16, name: 'SBI Small Cap Fund', category: 'Small Cap', returns: '27' },
     { id: 17, name: 'Axis Small Cap Fund', category: 'Small Cap', returns: '26' },
    { id: 18, name: 'Tata Small Cap Fund', category: 'Small Cap', returns: '25' },
